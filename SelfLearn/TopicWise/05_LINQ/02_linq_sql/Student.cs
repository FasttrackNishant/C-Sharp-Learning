    ...
    public class Student
    {
        ...
        public static List<Student> GetStudents()
        {
            List<Student> students = new List<Student>()
            {
                ...
                new Student { ID = 1002, Name = "Anurag", Gender = "Male", Branch = "ETC", Age = 21  },
                new Student { ID = 1003, Name = "Pranaya", Gender = "Male", Branch = "CSE", Age = 23  },
                ...
                new Student { ID = 1006, Name = "Priyanka", Gender = "Female",  Branch = "CSE", Age = 25 },
                new Student { ID = 1007, Name = "santosh", Gender = "Male", Branch = "CSE", Age = 22  },
                new Student { ID = 1008, Name = "Tina", Gender = "Female", Branch = "CSE", Age = 24  },
